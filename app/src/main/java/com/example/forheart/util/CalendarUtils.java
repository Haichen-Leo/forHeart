...
public class CalendarUtils {
    ...
    private static String CALENDARS_NAME = "forHEART";
    private static String CALENDARS_ACCOUNT_NAME = "NICKNAME";
    private static String CALENDARS_ACCOUNT_TYPE = "Activities";
    private static String CALENDARS_DISPLAY_NAME = "forHEART Activities";

    /**
     * Initiate DeepLink uri
     */
    static {
    ...
    private static Uri insertCalendarEvent(Context context, long calendar_id, String title, String description , long begintime, long endtime){
        ...
        event.put(CalendarContract.Events.HAS_ALARM, 1); // set alarm
